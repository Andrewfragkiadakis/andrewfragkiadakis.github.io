...
"[project]/andreas-technology-v2/node_modules/react-reconciler/cjs/react-reconciler-constants.development.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/andreas-technology-v2/node_modules/react-reconciler/constants.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/andreas-technology-v2/node_modules/react-reconciler/cjs/react-reconciler-constants.development.js [app-client] (ecmascript)");
}
}),
"[project]/andreas-technology-v2/node_modules/react-reconciler/cjs/react-reconciler.development.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"production" !== ("TURBOPACK compile-time value", "development") && (module.exports = function($$$config) {
    ...
    function createChildReconciler(shouldTrackSideEffects) {
        ...
        function createChild(returnFiber, newChild, lanes) {
            if ("string" === typeof newChild && "" !== newChild || "number" === typeof newChild || "bigint" === (typeof newChild === "undefined" ? "undefined" : _type_of._(newChild))) return newChild = createFiberFromText("" + newChild, returnFiber.mode, lanes), newChild["return"] = returnFiber, newChild._debugOwner = returnFiber, newChild._debugInfo = currentDebugInfo, newChild;
                        ...
                        a: {
                            for(var key = newChild.key; null !== currentFirstChild;){
                                if (currentFirstChild.key === key) {
                                    ...
                                    } else if (currentFirstChild.elementType === key || isCompatibleFamilyForHotReloading(currentFirstChild, newChild) || "object" === (typeof key === "undefined" ? "undefined" : _type_of._(key)) && null !== key && key.$$typeof === REACT_LAZY_TYPE && callLazyInitInDEV(key) === currentFirstChild.type) {
                                        deleteRemainingChildren(returnFiber, currentFirstChild.sibling);
    ...
    function handleActionReturnValue(actionQueue, node, returnValue) {
        null !== returnValue && "object" === (typeof returnValue === "undefined" ? "undefined" : _type_of._(returnValue)) && "function" === typeof returnValue.then ? (returnValue.then(function(nextState) {
    ...
    function updateActionStateImpl(stateHook, currentStateHook, action) {
        ...
        currentStateHook = "object" === (typeof currentStateHook === "undefined" ? "undefined" : _type_of._(currentStateHook)) && null !== currentStateHook && "function" === typeof currentStateHook.then ? useThenable(currentStateHook) : currentStateHook;
    ...
    function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
        ...
        if ("function" === typeof type) shouldConstruct(type) && (fiberTag = 1), resolvedType = resolveFunctionForHotReloading(resolvedType);
            ...
            case REACT_STRICT_MODE_TYPE:
                ...
                break;
            case REACT_PROFILER_TYPE:
                return type = pendingProps, owner = mode, "string" !== typeof type.id && console.error('Profiler must specify an "id" of type `string` as a prop. Received the type `%s` instead.', _type_of._(type.id)), key = createFiber(12, type, key, owner | 2), key.elementType = REACT_PROFILER_TYPE, key.lanes = lanes, key.stateNode = {
                    effectDuration: 0,
    ...
    var exports = {};
    "use strict";
    var React = __turbopack_context__.r("[project]/andreas-technology-v2/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), Scheduler = __turbopack_context__.r("[project]/andreas-technology-v2/node_modules/react-reconciler/node_modules/scheduler/index.js [app-client] (ecmascript)"), assign = Object.assign, REACT_LEGACY_ELEMENT_TYPE = Symbol["for"]("react.element"), REACT_ELEMENT_TYPE = Symbol["for"]("react.transitional.element"), REACT_PORTAL_TYPE = Symbol["for"]("react.portal"), REACT_FRAGMENT_TYPE = Symbol["for"]("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol["for"]("react.strict_mode"), REACT_PROFILER_TYPE = Symbol["for"]("react.profiler"), REACT_PROVIDER_TYPE = Symbol["for"]("react.provider"), REACT_CONSUMER_TYPE = Symbol["for"]("react.consumer"), REACT_CONTEXT_TYPE = Symbol["for"]("react.context"), REACT_FORWARD_REF_TYPE = Symbol["for"]("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol["for"]("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol["for"]("react.suspense_list"), REACT_MEMO_TYPE = Symbol["for"]("react.memo"), REACT_LAZY_TYPE = Symbol["for"]("react.lazy");
    ...
    }, reportGlobalError = "function" === typeof reportError ? reportError : function reportGlobalError(error) {
    ...
    var rendererSigil = {};
    var currentlyRenderingFiber = null, lastContextDependency = null, isDisallowedContextReadInDEV = !1, AbortControllerLocal = "undefined" !== typeof AbortController ? AbortController : function AbortControllerLocal() {
    ...
    ReactSharedInternals.S = function(transition, returnValue) {
        "object" === (typeof returnValue === "undefined" ? "undefined" : _type_of._(returnValue)) && null !== returnValue && "function" === typeof returnValue.then && entangleAsyncAction(transition, returnValue);
    ...
    exports.defaultOnCaughtError = function(error, errorInfo) {
        ...
        try {
            "object" === (typeof error === "undefined" ? "undefined" : _type_of._(error)) && null !== error && "string" === typeof error.environmentName ? bindToConsole("error", [
                "%o\n\n%s\n\n%s\n",
                error,
...
"[project]/andreas-technology-v2/node_modules/react-reconciler/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/andreas-technology-v2/node_modules/react-reconciler/cjs/react-reconciler.development.js [app-client] (ecmascript)");
}
}),
]);

//# sourceMappingURL=8e458_react-reconciler_31d6342e._.js.map